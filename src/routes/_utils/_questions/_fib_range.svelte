...
import { bind, prevent_default } from 'svelte/internal';
	...
	async function saveQuestion(){
		...
		if((!body.range_start || isNaN(body.range_start) || !body.range_end || isNaN(body.range_end))){
...
<h3 class="w3-black w3-round w3-padding width">{edit?"Edit a":"Create a"} <span class="w3-text-grey"> Fill blanks with Range Question</span></h3>
<div class="width">
	{#if edit}
