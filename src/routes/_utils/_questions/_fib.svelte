...
<h3 class="w3-black w3-round w3-padding width">{edit?"Edit a":"Create a"} <span class="w3-text-grey"> Fill In the Blanks Question</span></h3>
<div class="width">
	{#if edit}
	...
	<form on:submit|preventDefault={saveQuestion}>
		...
		<input type="text" placeholder=" Correct Answer" bind:value={body.correct_answer}>
