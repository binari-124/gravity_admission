...
{#if body}
  <div class="">
    ...
    <div class="container" style="--template-color:red">
      ...
      <a
        class="w3-button w3-round w3-card w3-hover-green w3-margin"
        href="/students/student_fee/{studentId}">Fee Management</a
      >
      <a
        class="w3-button w3-round w3-card w3-hover-green w3-margin"
      ...
      <a
        class="w3-button w3-round w3-card w3-hover-green w3-margin"
        href="/students/student_address/{studentId}">Addresses</a
      >
        ...
        <form id="registration" class="w-full mx-auto p-6">
          ...
          <div class=" flex flex-col">
            ...
            <p class="w3-input w3-border w3-round w3-margin">
              {body.branch?body.branch.name:"-"}
            </p>

            <p class="w3-left">Stream</p>

            <p class="w3-input w3-border w3-round w3-margin">
              {body.stream?body.stream.name:"-"}
            </p>
          ...
          <p class="w3-input w3-border w3-round w3-margin">{body.batch}</p> -->
            ...
            <div class="mx-5 my-6">
              ...
              <div class=" my-1 flex mt-2">
                ...
                <p class="flex-1 border-2 rounded-md p-1">{body.nationality}</p>
              </div>

              <div class=" my-1 flex mt-2">
                <p class="mt-1 mr-2" for="mobile_parents">Mobile Parents:</p>
                <p class="flex-1 border-2 rounded-md p-1">
                  {body.mobile_parents}
                </p>
              </div>
              ...
              <div class=" my-1 flex mt-2">
                <p class="mt-1 mr-2" for="mobile_students">Mobile Students:</p>
                <p class="flex-1 border-2 rounded-md p-1">{body.phone}</p>
              </div>

              <div class=" my-1 flex mt-2">
                <p class="mt-1 mr-2" for="e_mail_id">E-Mail ID:</p>
                <p class="flex-1 border-2 rounded-md p-1">{body.email}</p>
              </div>
            ...
            <div class=" my-1 flex mt-2">
              ...
              <div class=" my-1 flex mt-2">
                <p class="mt-1 mr-2">Phone (Residence):</p>
                <p class="flex-1 border-2 rounded-md p-1">
                  {body.phone_residence}
                </p>
              </div>
            ...
            Mandatory Fields are marked with asterick(*)
              ...
              <div class=" my-1 flex mt-2">
                <p class="mt-1 mr-2">Schools/College Name:</p>
                <p class="flex-1 border-2 rounded-md p-1">{body.school_name}</p>
              </div>
              ...
              <div class="flex flex-row mt-8">
                ...
                <p class="text-xs mt-1 ml-4 mr-2">
                  Percentage of Class VII/VIII/IX/X
                </p>
                <p class="border-2 w-16">{body.percentage_of_secondary}</p>

                <p class="text-xs mt-1 ml-4 mr-2">
                  %(X/XII Board, PCM-Aggregate)
                </p>
                <p class="border-2 w-16">{body.senior_secondary_pcm}</p>

                <p class="text-xs mt-1 ml-4 mr-2">
                  %(X/XII Board, PCB-Aggregate)
                </p>
                <p class="border-2 w-16">{body.senior_secondary_pcb}</p>
              </div>

              <div class="flex flex-row mt-8">
                <p>Grades Obtained</p>

                <p class="text-xs mt-1 ml-4 mr-2">In Science</p>
                <p class="border-2 w-16 h-7">{body.science_grades}</p>

                <p class="text-xs mt-1 ml-4 mr-2">In Math</p>
                <p class="border-2 w-16 h-7">{body.math_grades}</p>

                <p class=" mt-1 justify-end ml-24 mr-2 h-7">Exam Board</p>
                <p class="border-2 justify-end h-7">{body.board}</p>
                <p class=" mt-1 justify-end ml-4 mr-2">
                  (CBSE/ICSE/ISC/UP/Others)
                </p>
                <br /><br /><br />
              </div>
            </div>
