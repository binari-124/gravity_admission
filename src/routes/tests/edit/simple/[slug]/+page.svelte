<script>
  ...
  export let data;
  export let testId = data.testId;
  console.log("studentID from slug:" + testId);
  ...
  import Test from "../../_utils/_tests/test.svelte";
  ...
  onMount(async () => {
    ...
    const res = await fetch(loginPath + "/panel/test_get/" + testId, {
      mode: "cors",
      method: "get",
