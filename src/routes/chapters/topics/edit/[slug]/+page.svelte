...
console.log("topicID from slug:" + topicId);	
	...
	async function getBody(){
		...
		let res;
			...
			res = await fetch(loginPath+'/panel/topic_get/'+topicId,{mode:'cors',method:'get',headers:{'Authorization':'Bearer '+token,'Content-Type':'application/json'}});
	...
	async function handleSubmit(){
		...
		else
		{
			...
			res = await fetch(loginPath+'/panel/topic_create',{mode:'cors',method:'post',headers:{'Authorization':'Bearer '+token,'Content-Type':'application/json'},body:JSON.stringify(body)});
