      ...
      <div class="flex flex-wrap -mx-4">
         <div class="w-full px-4">
            <div class="text-center mx-auto mb-12 lg:mb-20 max-w-[510px]">
               ...
               <h2
                  class=" text-3xl sm:text-4xl md:text-[40px] text-dark mb-4"
                  >
                  Let the <span class="font-bold text-blue-600">energy</span> of the cosmos in your <span class="font-bold text-blue-600">life</span>...
               </h2>
               <p class="text-blue-700 text-body-color">
                  <!-- Let the energy of the <b>cosmos</b> flow through your <b>hands</b>... -->
                  We have the most inclusive of all programmes for your spiritual uplifting...
               </p>
            </div>
         </div>
      </div>
            ...
            <div
               ...
               <h4 class="font-semibold text-xl text-dark mb-3">
                 ...
                 <p class="text-body-color">
                    We provide Dowsing sessions for your queries. Get to know the answers you seek
                 </p>
            </div>
         </div>
         <div class="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <h4 class="font-semibold text-xl text-dark mb-3">
                 ...
                 <p class="text-body-color">
                    We provide Healing sessions as well as Reiki I,II,III and Master level courses.
                 </p>
            </div>
         </div>
         <div class="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <p class="text-body-color">
                  Make the best of your humble abode or a work place by balancing energies from all over.
               </p>
            </div>
         </div>
         <div class="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <p class="text-body-color">
                 Numerology based predictions and awareness induction.
               </p>
            </div>
         </div>
         <div class="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <p class="text-body-color">
                 Know Thyself. What is better than the truth seeking TAROT CARDS
               </p>
            </div>
         </div>
         <div class="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <p class="text-body-color">
                  Set aside your fears and undesirable pain by resolving issues in your past life. 
               </p>
            </div>
         </div>
      </div>
