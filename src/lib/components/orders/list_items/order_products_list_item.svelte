<script>
  export let product={thumbnail:"./dowser.png",name:"Some",product_type:"some type"};
</script>
            ...
            <li class="flex py-6">
              ...
              <div class="ml-4 flex flex-1 flex-col">
                ...
                <div class="flex flex-1 items-end justify-between text-sm">
                  ...
                  <!-- <div class="flex">
                    <button type="button" on:click={handleRemove} class="font-medium text-indigo-600 hover:text-indigo-500">Cancel</button>
                  </div> -->
                </div>
              </div>
            </li>
