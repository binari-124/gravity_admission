<section id="team" class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12 bg-white">
  ...
  <!-- lg -->
    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white rounded-lg p-6">
            <div class="flex items-center space-x-6 mb-4">
                ...
                src="/drsursbhi.jpeg" alt="photo">
                <div>
                    <p class="text-xl text-gray-700 font-normal mb-1">Dr Surabhi A.K.A. Guru Maa</p>
                    <p class="text-base text-blue-600 font-normal">President Awardee & Grand Master</p>
                    <p class="text-base text-blue-900 font-normal">+91-9897068446</p>
                </div>
            </div>
            <div>
                <p class="text-gray-400 leading-loose font-normal text-base">Occult Master and Master of Spiritual Healing...</p>
            </div>
        </div>
        <div class="bg-white rounded-lg p-6">
            <div class="flex items-center space-x-6 mb-4">
                <img class="h-28 w-28 object-cover object-center rounded-full" src="/rajsharma.jpeg" alt="photo">
                <div>
                    <p class="text-xl text-gray-700 font-normal mb-1">Raj Sharma</p>
                    <p class="text-base text-blue-600 font-normal">Reiki Grand Master & Healer</p>
                    <p class="text-base text-blue-900 font-normal">+91-9897058445</p>
                </div>
            </div>
            <div>
                <p class="text-gray-400 leading-loose font-normal text-base">Reiki Healing Associate</p>
            </div>
        </div>
    ...
    <h4 class="text-2xl text-center">Centers</h4>
    ...
    <div class="bg-white rounded-lg p-6">
        <div class="flex items-center justify-center space-x-6 mb-4">
            <!-- <img class="h-28 w-28 object-cover object-center rounded-full"  -->
            <!-- src="/static/dowser.png" alt="photo"> -->
            <div>
                <p class="text-xl text-gray-700 font-normal mb-1 text-center">Rishikesh</p>
                <p class="text-base text-center text-blue-600 font-normal">Flat# 209 Block-C Deecon Valley</p>
                <iframe class="w-full m-0 p-10 rounded margin " src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1725.3425881562416!2d78.32100918413647!3d30.131820896184568!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3909164744d268f1%3A0x53836c5edfc6173b!2sDeecon%20Valley%20Apartment!5e0!3m2!1sen!2sin!4v1652377903467!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

                <!-- <p class="text-base text-blue-900 font-normal">Rishikesh</p> -->
            </div>
        </div>
        <div>
            <!-- <p class="text-gray-400 leading-loose font-normal text-base">Occult Master and Master of Spiritual Healing...</p> -->
    ...
    <div class="bg-white rounded-lg p-6">
        <div class="flex items-center justify-center space-x-6 mb-4">
            <!-- <img class="h-28 w-28 object-cover object-center rounded-full" src="/static/dowser.png" alt="photo"> -->
            <div>
                <p class="text-xl text-gray-700 font-normal mb-1 text-center">Bareilly</p>
                <p class="text-base text-center text-blue-600 font-normal">72-D Sun-City Vistar</p>
                <!-- <iframe class="w-full m-0 p-10 " src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1725.3425881562416!2d78.32100918413647!3d30.131820896184568!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3909164744d268f1%3A0x53836c5edfc6173b!2sDeecon%20Valley%20Apartment!5e0!3m2!1sen!2sin!4v1652377903467!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> -->
                <iframe class="w-full m-0 p-10 " src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d56165.35560617417!2d79.4545844!3d28.3789564!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4366bb2dcceb05ab!2sReiki%20Healing%20Heaven!5e0!3m2!1sen!2sin!4v1652425071432!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <!-- <p class="text-base text-blue-900 font-normal">Bareilly</p> -->
            </div>
        </div>
        <div>
            <!-- <p class="text-gray-400 leading-loose font-normal text-base">Reiki Healing Associate</p> -->
